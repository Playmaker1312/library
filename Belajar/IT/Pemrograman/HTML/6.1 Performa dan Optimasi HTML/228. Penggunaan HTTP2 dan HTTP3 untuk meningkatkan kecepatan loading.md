...
<body>
  ...
  <div class="card">
    ...
    <table style="width:100%;border-collapse:collapse;">
      ...
      <tr><td style="padding:8px;">Multiplexing</td><td style="padding:8px;">Tidak</td><td style="padding:8px;">Ya</td><td style="padding:8px;">Ya</td></tr>
      <tr><td style="padding:8px;">Header Compression</td><td style="padding:8px;">Tidak</td><td style="padding:8px;">Ya (HPACK)</td><td style="padding:8px;">Ya (QPACK)</td></tr>
      <tr><td style="padding:8px;">0-RTT Reconnect</td><td style="padding:8px;">Tidak</td><td style="padding:8px;">Tidak</td><td style="padding:8px;">Ya</td></tr>
      ...
      <tr><td style="padding:8px;">Server Push</td><td style="padding:8px;">Tidak</td><td style="padding:8px;">Ya</td><td style="padding:8px;">Ya</td></tr>
    </table>
  </div>
  ...
  <script>
    function deteksiProtokol() {
      ...
      info.innerHTML =
        'Waktu deteksi: ' + waktu + '\n' +
        'Protokol: ' + protocol + '\n' +
        'HTTPS: Ya (diperlukan untuk HTTP/2 dan HTTP/3)\n' +
        'ALPN: Ya (negosiasi protokol otomatis)';
